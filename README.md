...
The benchmark is split by build type for comparison, but both configurations use the same regression guard for now: a slowdown above 10% is treated as a failure.
...
![Performance benchmark chart](docs/images/performance-benchmark-Release.svg)
